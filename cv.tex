...
\begin{cv}{\Author{António Alegria}}
  ...
  \begin{itemize}[nosep,noitemsep,leftmargin=3.85em]
	  \item Currently leading and co-developing data-processing and machine learning components of new real-time fraud detection product. \Tech{Scala, Java, Akka, Hadoop, Twitter Storm, CEP, R}.
